...
import Historico from "./components/pages/historico/Historico.jsx"; // 👈 IMPORTA AQUI
...
function App() {
  ...
  // 👇 só login e register são páginas sem sidebar
  ...
  // ===== TELAS DE LOGIN / REGISTER (sem sidebar/header) =====
  if (isAuthPage) {
    return (
      <Routes>
        <Route
      ...
      <div className="app__main">
        ...
        <main className="app__content">
          <Routes>
            ...
            <Route
              path="/profile"
              element={<Profile user={user} onUserChange={setUser} />}
            />
            ...
            {/* 👇 AQUI A ROTA DO HISTÓRICO, DENTRO DO MESMO LAYOUT */}
